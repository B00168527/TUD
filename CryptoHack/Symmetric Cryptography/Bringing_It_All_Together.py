...
def inv_sub_bytes(s, inv_s_box=inv_s_box):
    ...
    for row in range(4):
        for col in range(4):
            # Set the cell value of the matrix to be the substitue value for the sbox index of the value in the cell of s
            temp_matrix[row][col] = inv_s_box[s[row][col]]
    return temp_matrix
